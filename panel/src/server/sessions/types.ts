...
// - deliberately flat (no legacy `stats` envelope) and free of the legacy
// dashboard's `acpId`/`live`/`busy` fields, which described a stateful ACP
// connection this read-only panel never holds.
//
